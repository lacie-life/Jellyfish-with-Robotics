...
void forward_ ()
{
  m.motor(1,FORWARD,230);
  m.motor(2,FORWARD,230);
  m.motor(4,FORWARD,230);
  m.motor(3,FORWARD,230);  
}
void backward_ ()
{
  m.motor(1,BACKWARD,230);
  m.motor(2,BACKWARD,230);
  m.motor(4,BACKWARD,230);
  m.motor(3,BACKWARD,230);   
}
void left_()
{
  m.motor(1,FORWARD,230);
